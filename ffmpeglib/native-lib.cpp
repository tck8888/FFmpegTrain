...
Java_com_tck_ffmpegtrain_TPlayer_native_1prepare(JNIEnv *env, jobject instance,
                                                 jstring dataSource_) {
    const char *dataSource = env->GetStringUTFChars(dataSource_, 0);
    JavaCallHelper *javaCallHelper = new JavaCallHelper(javaVm, env, instance);
    ffmpeg = new TCKFFmpeg(javaCallHelper, dataSource);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_tck_ffmpegtrain_TPlayer_native_1start(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_tck_ffmpegtrain_TPlayer_native_1setSurface(JNIEnv *env, jobject instance,
                                                    jobject surface) {
